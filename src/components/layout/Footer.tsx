                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
                    <div>
                        ...
                        <ul className="space-y-2">
                            ...
                            <li><Link href="/calendar" className="hover:text-blue-300">School Calendar</Link></li>
                        </ul>
                    </div>
                    ...
                    <div>
                        ...
                        <ul className="space-y-2">
                            <li><Link href="/portal" className="hover:text-blue-300">Student Portal</Link></li>
                            <li><Link href="/faculty" className="hover:text-blue-300">Faculty Portal</Link></li>
                            <li><Link href="/library" className="hover:text-blue-300">Library</Link></li>
